...
def compute_z(
    ...
    if use_modified:
        ...
        print(f"Loading SAE path for {model.config._name_or_path} at layer {layer}")
        using_sae = True
        device = (
    ...
    def edit_output_fn(cur_out, cur_layer):
        ...
        if cur_layer == hparams.layer_module_tmp.format(layer):
            ...
            if not use_modified:
                # Original behavior: add delta directly in residual space
